...
{
    public function test_container_instances_should_be_same_if_an_old_instance_is_given()
    {
    ...
    public function test_container_instances_given_to_dependencies_will_be_same_if_singleton_and_resolved_during_boot()
    {
        [$app, $worker, $client] = $this->createOctaneContext([
            Request::create('/first', 'GET'),
        ]);
